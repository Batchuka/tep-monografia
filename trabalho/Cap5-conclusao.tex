...
\begin{enumerate}
  ...
  Para uso em cenários industriais reais, o Operator deve executar próximo ao hardware de campo. Distribuições leves como k3s ou o framework KubeEdge \cite{KUBEEDGE2023} são adequados para PLCs e gateways industriais, permitindo que a mesma lógica supervisória desenvolvida aqui seja implantada em produção sem reescrita.
